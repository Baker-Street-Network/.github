...
| [correctly-set-in-progress](https://github.com/Baker-Street-Network/correctly-set-in-progress)| 18.0       | Correctly set fsm_done when a task is set to In Progress.                |
